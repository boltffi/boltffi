...
Apple and Android produce packages you can import directly. C# currently generates source files that you include in your .NET project alongside the host Rust `cdylib`.
