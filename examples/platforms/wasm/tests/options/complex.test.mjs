...
export async function run() {
  globalThis.demoCase("case:options.complex.string.some_none");
  ...
  globalThis.demoCase("case:options.complex.point.some_none");
  ...
  globalThis.demoCase("case:options.complex.vec_optional_i32.mixed");
