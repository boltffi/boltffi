...
export async function run() {
  globalThis.demoCase("case:records.blittable.point.functions");
  ...
  globalThis.demoCase("case:records.blittable.point.try_make");
  ...
  globalThis.demoCase("case:records.blittable.color.basic");
