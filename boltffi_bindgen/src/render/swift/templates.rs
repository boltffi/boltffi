...
mod tests {
    ...
    #[test]
    fn snapshot_data_enum_recursive() {
        let e = SwiftEnum {
            name: "Tree".to_string(),
            style: SwiftEnumStyle::Data,
            c_style_tag_type: None,
            ...
            variants: vec![
                SwiftVariant {
                    swift_name: "leaf".to_string(),
                    discriminant: 0,
                    payload: SwiftVariantPayload::Tuple(vec![field(
                        "value",
                        "Int32",
                        read_primitive(PrimitiveType::I32, offset("pos")),
                        write_primitive(PrimitiveType::I32, "value"),
                        None,
                        None,
                    )]),
                    doc: None,
                ...
                SwiftVariant {
                    ...
                    payload: SwiftVariantPayload::Struct(vec![
                        field(
                            ...
                            "Tree",
                            read_primitive(PrimitiveType::I32, offset("pos")),
                            write_primitive(PrimitiveType::I32, "left"),
                            None,
                            None,
                        ),
                        field(
                            ...
                            "Tree",
                            read_primitive(PrimitiveType::I32, offset("pos")),
                            write_primitive(PrimitiveType::I32, "right"),
                            None,
                            None,
                        ),
                    ]),
